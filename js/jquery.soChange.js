	...
	$.fn.extend({
		"soChange": function(o){
			...
			o= $.extend({
				...
				botPrev:null,//按钮上一个
				botNext:null,//按钮下一个
				changeType:'slide',//切换方式，可选：fade,slide，默认为fade
				thumbNowClass:'now',//导航对象当前的class,默认为now
				thumbOverEvent:true,//鼠标经过thumbObj时是否切换对象，默认为true，为false时，只有鼠标点击thumbObj才切换对象
				slideTime:0,//平滑过渡时间，默认为1000ms，为0或负值时，忽略changeType方式，切换效果为直接显示隐藏
				...
				stopObj:null//鼠标移动上去停留容器对象
			}, o || {});

			var _self = $(this);
			var isOver=false;//是否鼠标悬停
			var thumbObj;
			var size = _self.size();
			...
			//切换到下一个
			function runNext() {
                 setTimeout(runNext,o.changeTime);				
				if(!isOver){
		...
		//自动运行
			if (o.autoChange) {
				...
				hover($(o.thumbObj).parent());				
				hover(o.stopObj);					
				if(o.botPrev && o.botNext){
					hover(o.botPrev);
					hover(o.botNext);
